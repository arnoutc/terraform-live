# Hello-world app example (development environment)
...
In `variables.tf`, fill in the name of the S3 bucket and key where the remote state is stored for the Postgres database 
and ALB (you must deploy the configurations in [data-stores/postgres](../../data-stores/postgres) first):
